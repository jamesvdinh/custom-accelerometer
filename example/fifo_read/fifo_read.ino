...
void setup(void) {
    ...
    adxl357b.setAdxlRange(FOURTY_G); // see .h file for other settings
...
void loop(void) {
    ...
    if (adxl357b.checkDataReady()) {
        ...
        adxl357b.getFifoEntry(entry);
        
        SERIAL.print("FIFO entry = ");
        SERIAL.println(entry);
        
        if (adxl357b.readXYZAxisResultDataFromFIFO(x, y, z)) {
